  ...
  return (
    <button
      className="relative bg-transparent border border-border 
        text-foreground hover:border-silver-300/50 transition-all 
        duration-500 focus:outline-none focus-visible:ring-2 
        focus-visible:ring-silver-200 focus-visible:ring-offset-2 focus-visible:ring-offset-background 
